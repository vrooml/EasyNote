...
public class MySlideRecyclerView extends RecyclerView{
    ...
    public MySlideRecyclerView(Context context,@Nullable AttributeSet attrs){
        super(context,attrs);
        init();
    }

    public MySlideRecyclerView(Context context,@Nullable AttributeSet attrs,int defStyle){
